...
export default function Erreur403() {
    return (
        <Fragment>
            <use>
                <svg x="0px" y="0px"
                     viewBox="0 0 1000 1000" className="whistle">
        <g>
            ...
            <h1 className="h1-403">403</h1>
            <h2 className="h2-403">Pas cette fois, accès interdit !</h2>
        </Fragment>
    );
}

customElements.define('erreur-403', reactToWebComponent(Erreur403, React, ReactDOM))